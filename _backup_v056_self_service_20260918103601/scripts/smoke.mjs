...
ok('Pacote FoodWeb v0.5.5',pkg.name==='foodservice-saas'&&pkg.version === '0.5.5');
...
console.log(`\nSmoke FoodWeb v0.5.5 concluído: ${checks.length} verificações + ${sourceFiles.length} arquivos TS/TSX.`);
