...
ok('Pacote FoodWeb v0.5.2',pkg.name==='foodservice-saas'&&pkg.version==='0.5.2');
...
console.log(`\nSmoke FoodWeb v0.5.1 concluído: ${checks.length} verificações + ${sourceFiles.length} arquivos TS/TSX.`);
