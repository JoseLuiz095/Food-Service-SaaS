...
echo ============================================================
echo FoodWeb v0.5.3 - Validar e publicar em PRODUCAO
echo ============================================================
echo.
...
echo.
set /p CONFIRM=Publicar FoodWeb v0.5.3 diretamente em PRODUCAO? [S/N]: 
if /i not "%CONFIRM%"=="S" exit /b 0

echo [1/9] Conferindo v0.5.3...
...
if not exist "dist\favicon-foodweb-v053.svg" (
  echo FALHA: favicon-foodweb-v053.svg nao entrou no build.
  goto :fail
)
findstr /C:"favicon-foodweb-v053.svg" "dist\index.html" >nul
if errorlevel 1 (
  echo FALHA: index do build nao referencia favicon v0.5.3.
  goto :fail
)
...
echo.
echo ============================================================
echo SUCESSO - FoodWeb v0.5.3 publicado em PRODUCAO.
echo ============================================================
pause
exit /b 0
