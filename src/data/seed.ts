...
export const seedPlan: Plan = {
  ...
  monthlyPrice: 0, setupPrice: 0, categoryLimit: null, addonLimit: null, adminUserLimit: 5, sortOrder: 0,
  featureCodes:['catalog','orders','whatsapp','delivery','billing_pix','analytics','custom_banner','finance','multi_user'], featureLimits:{},
};
