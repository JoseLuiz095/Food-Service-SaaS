...
export const seedSettings: StoreSettings = {
  ...
  averagePreparationMin: 30, averagePreparationMax: 45, allowScheduledOrders: true, kdsEnabled: true, kdsNotifyCustomer: true, salesRecoveryEnabled: true, salesRecoveryMinutes: 10, crmEnabled: true, repeatOrderEnabled: true, upsellEnabled: true, upsellLimit: 3,
