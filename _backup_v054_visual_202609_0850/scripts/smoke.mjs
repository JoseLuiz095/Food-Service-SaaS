...
ok('Pacote FoodWeb v0.5.4',pkg.name==='foodservice-saas'&&pkg.version==='0.5.4');
...
console.log(`\nSmoke FoodWeb v0.5.4 concluído: ${checks.length} verificações + ${sourceFiles.length} arquivos TS/TSX.`);
